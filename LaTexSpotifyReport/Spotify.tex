...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.45]{3models}
...
The model that yielded greatest accuracy were the medium and complex decision trees, both yielding 99.3\% accuracy using 13 features listed above.
